...
export const SearchForm = () => {
  ...
  const handleDestinationChange = (geo: GeoObject) => {
    setDestination(geo);
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
      <div className="flex flex-col gap-4 p-6 bg-white border border-gray-200 rounded-lg shadow-md">
        ...
        <button
          type="submit"
          className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          Знайти
        </button>
      </div>
