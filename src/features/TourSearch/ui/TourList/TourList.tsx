...
import { useHotelDetails } from "../../model/hooks/useHotelDetails";
import { Loader, ErrorMessage, EmptyList } from "@/shared/ui";
import { TourItem, type Price, type Tour } from "@/entities/Tour";
